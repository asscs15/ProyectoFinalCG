...
int main()
{
	...
	Circuito_M = Model();
	Circuito_M.LoadModel("Models/circuito.obj");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		carroV = glm::mat4(1.0);
		carroV = glm::scale(carroV, glm::vec3(0.3f, 0.3f, 0.3f));
		carroV = glm::translate(carroV, glm::vec3(movCoche, 0.5f, -50.5f));
		...
		circuito = glm::mat4(1.0);
		circuito = glm::translate(circuito, glm::vec3(-10.0f, 23.0f, -1.0));
		circuito = glm::scale(circuito, glm::vec3(1.5f, 1.5f, 1.5f));
		//circuito = glm::rotate(circuito, -90 * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(circuito));
		Circuito_M.RenderModel();
